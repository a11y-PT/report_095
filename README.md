---
website: "Serviços de Ação Social do Instituto Politécnico de Coimbra"          # Entre as aspas escreve o nome do website
date: "13/07/2026"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://sasocial.ipc.pt/dashboard"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://sasocial.ipc.pt/acessibilidade" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
owner: "Serviços de Ação Social do IP de Coimbra"         # Entre as aspas escrever o nome do owner do website
